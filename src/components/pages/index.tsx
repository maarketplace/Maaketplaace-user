        ...
        <div className="w-[100%] p-[0px] dark:bg-black max-w-fill">
            ...
            <div className="w-[100%] flex h-[90vh] ">
                ...
                <div className={isDetailsPage || isQuicksPage || isStorePage ? 'w-[100%]' : "w-[85%] flex flex-col items-center justify-center h-[100%] max-[650px]:w-[100%] ml-[200px] max-[650px]:ml-[0px] "}>
                    ...
                    <div className={isQuicksPage || isDetailsPage ? "w-[100%] h-[8%] bg-white text-black fixed right-0 bottom-0 z-50 flex items-center justify-center dark:bg-[black] dark:text-white max-[650px]:w-[100%]" : "w-[85%] h-[8%] bg-white text-black fixed right-0 bottom-0 z-50 dark:bg-[black] dark:text-white max-[650px]:w-[100%]"}>
                        <Bottom />
                    </div>
                </div>
            </div>

...
const Details = () => {
    ...
    return (
        <div className="w-full h-full mt-[100px] flex flex-col items-center max-[650px]:mt-[40px]">
            <div className="w-full flex gap-[10px] justify-center max-[650px]:flex-col">
                ...
                <div className="w-[50%] h-[300px] bg-slate-50 max-[650px]:w-full">
                ...
                <div className="w-[100%] p-0 flex flex-wrap gap-[10px] max-[650px]:w-full">
                    ...
                    >
                        {relatedProduct?.map((i: IProduct) => (
                            ...
                            >
                                <div className="h-[200px] flex items-center justify-center mb-[10px] max-[650px]:w-full max-[650px]:h-[150px]">
                                    <img
                                        src={i?.productImage}

...
const Store = () => {
    ...
    return (
        <div className="mt-[30px] w-[100%] flex items-center justify-center flex-col gap-[20px]">
            <div className="w-[95%] h-[auto] p-[2%] shadow-lg shadow-grey-500/50 bg-slate-50  dark:bg-[#1D1C1C] dark:shadow-white-500/50 rounded-[16px]  max-[650px]:w-[90%] max-[650px]:p-[2%]">
                <div className="w-[60%] flex flex-col gap-[10px] max-[650px]:w-[100%] max-[650px]:items-center ">
                    <div className=" w-[100%] flex items-center gap-5 max-[650px]:flex-col">
                        <span className="flex flex-col items-center gap-[10px] relative">
                            ...
                            <p className="text-[10px] font-bold hidden max-[650px]:flex ">{AdminInfo?.profession}</p>
                        </span>
                        <span className="h-[100px] w-[50%] gap-2 max-[650px]:w-[100%] max-[650px]:flex max-[650px]:items-center max-[650px]:flex-col">
                            <p className="text-clamp">@{AdminInfo?.business_name}</p>
            ...
            <div className="w-[95%] mb-[70px] flex flex-wrap gap-[20px] max-[650px]:justify-center max-[650px]:w-[100%]">
                {
